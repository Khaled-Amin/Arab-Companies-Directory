...
@section('content')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
        ...
        <!-- End Navbar -->
             ...
             <form action="{{ url('searchUser') }}" method="GET" class="container ">
            @csrf
                <!-- قسم مربع البحث -->
                <div class=" row justify-content-center">
                    <input type="text" class="form-controll search-main col-5" name="name" id="exampleFormControlInput1" placeholder="بحث عن عضو محدد">
        ...
        <ul>
            @foreach ($errors->all() as $item)
                <li class="p-3" style="height:3rem;border-radius:10px;    background-color: #42424a ; color:#fff;">
                    {{$item}}
                </li>
            @endforeach
        </ul>
                    ...
                    @foreach ($users as $user)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="{{route('goToUniqueMember', ['id' => $user->id])}}" ><i class="fa-solid fa-paper-plane"></i></a>
                                    </div>
                                    <div class="col-sm">
                                            <a href="{{route('destroy', ['id' => $user->id])}}"><i class="fa-solid fa-trash-can"></i></a>
