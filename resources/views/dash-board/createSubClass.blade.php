...
@section('content')
    ...
    @endif
        ...
        <div class="row backgroundW p-4 m-3">
            ...
            <form action="{{ route('storeSubClass') }}" method="post" >
                @csrf
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="name_subClass" placeholder="ادخل اسم الصفحة" class="form-controll">
                </div>

                <div class="col-md-12 mb-3">
                    <label for="Description" class="form-labell ">رابط التصنيف الفرعي</label>
                    <input type="text" name="href_subClass" placeholder="ادخل رابط الصفحة" class="form-controll">

                </div>

                <div class="col-md-12 mb-3">
                    <label for="Description" class="form-labell ">كلمات مفتاحية</label>
                    <input type="text" name="keywords_subClass" placeholder="ادخل كلمات مفتاحية" class="form-controll">
                </div>
