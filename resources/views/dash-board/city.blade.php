    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
        ...
        <div class="row backgroundW p-4 m-3">
            <div class="container d-flex justify-content-start">
                ...
                <a  class="btn fs-6" style="background-color: #38383e;color:#fff;border:0px;" href="{{ route('createCity') }}"> إضافة مدينة جديدة</a>
            </div>
...
@isset($cities)
                    @foreach ($cities as $city)
                        ...
                        <tr>
                            ...
                            <td>{{$city->name_country}}</td>
                          

                            <td>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="{{route('editCity' , $city->id)}}" ><i class="fa-solid fa-pen-to-square"></i></a>
                                    </div>
                                    <div class="col-sm">
                                            <a href="{{route('deleteCity', ['id' => $city->id])}}"><i class="fa-solid fa-trash-can"></i></a>
