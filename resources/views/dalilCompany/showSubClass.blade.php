...
@section('content')
    <section class="section-part mt-4 mb-5">
                <div class="container">
                    <div class="part">
                        <h6><a class="cu1" href="{{route('goToClasses',['nameCountry'=>$nameCountry,'ClassName'=>$className])  }}" >{{$classNameArabic}}</a> / 
                        <a class="cu1" href="{{route('goToSubclass',['nameCountry'=>$nameCountry,'ClassName'=>$className,'nameSubclass'=>$href_subclass])}}">{{$nameSubclass}}</a></h6>
                        <div class="btns">
